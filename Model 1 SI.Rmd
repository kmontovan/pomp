...
simuldata <-read_csv("https://raw.githubusercontent.com/kmontovan/pomp/refs/heads/main/SimulatedPompitisData.csv")|>as.data.frame()
...
SI_Model <- pomp(
  data = simuldata,
    ...
    t0=0, 
    rinit=si_rinit,
    rprocess=euler(step.fun = si_step,delta.t= 1/4), 
    rmeasure=si_rmeas,
    dmeasure=si_dmeas,
...
SI_ModelC <- pomp(
  data = simuldata,
    ...
    t0=0, 
    rinit=si_rinitC,
    rprocess=euler(step.fun = si_stepC,delta.t= 1/4), 
    rmeasure=si_rmeasC,
    dmeasure=si_dmeasC,
    statenames=c("S","I","NewI"),
    accumvars="NewI",
